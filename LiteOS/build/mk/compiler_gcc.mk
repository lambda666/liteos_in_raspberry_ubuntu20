...
GCCLIB_PATH_64 = $(GCCLIB_PATH_32)# $(LITEOS_COMPILER_PATH)/lib64/gcc/$(COMPILE_NAME)/$(VERSION_NUM)

CXXLIB_PATH_32 = $(LITEOS_COMPILER_PATH)/lib
CXXLIB_PATH_64 = $(CXXLIB_PATH_32)# $(LITEOS_COMPILER_PATH)/$(COMPILE_NAME)/lib64
...
$(warning $(LITEOS_COMPILER_CXX_PATH))
$(warning $(LITEOS_CXXINCLUDE))
